...
/*   Updated: 2025/01/02 09:23:26 by mjadid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("Veuillez entrer le bruit de phase Bφ en radians : ");
        double Bphi;
        scanf("%lf", &Bphi);

        printf("Veuillez entrer le bruit de l'energie Be en radians : ");
        double Be;
        scanf("%lf", &Be);
